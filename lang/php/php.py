...
"""a set of fields used in php docstrings that will follow the
...
mod.list("php_docstring_fields", desc="php docstring fields")
ctx.lists["user.php_docstring_fields"] = docstring_fields
...
mod.list("php_exception", desc="php exceptions")
ctx.lists["user.php_exception"] = {
...
class UserActions:
    ...
    def code_state_case():
        actions.insert('case \nbreak;')
        actions.edit.up()
    def code_state_for(): actions.auto_insert('foreach(container as object) {}')
